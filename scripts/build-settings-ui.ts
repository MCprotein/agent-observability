...
const schemaPath = "contracts/local-runtime-config-v2.schema.json";
...
await writeFile(`${generatedUiPath}/local-runtime-config-v2.d.ts`, declarations, "utf8");
...
await Promise.all([
  writeFile(
    `${generatedUiPath}/validate-local-runtime-config-v2.js`,
    standaloneCode(ajv, validate),
    "utf8",
  ),
  writeFile(
    `${generatedUiPath}/validate-local-runtime-config-v2.d.ts`,
