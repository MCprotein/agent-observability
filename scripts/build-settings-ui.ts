...
const schemaPath = "contracts/local-runtime-config-v4.schema.json";
const generatedUiPath = "ui/settings/generated";
const generatedRustPath = "crates/local-ui/src/generated";
const banner = "Generated from contracts/local-runtime-config-v4.schema.json. Do not edit.";
...
await writeFile(`${generatedUiPath}/local-runtime-config-v4.d.ts`, declarations, "utf8");
