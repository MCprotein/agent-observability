...
| v1.5.0 | In Progress | Local visual configuration console | Ephemeral loopback-only settings process, Rust-authoritative atomic configuration, TypeScript responsive policy visualizations, security/browser/accessibility smoke, independent review |
