...
| v0.11.0 | Planned | Rust Cursor adapter | official-hook capability entry, generation correlation, generic tool operation capture, specific shell/MCP/file hook diagnostic isolation, raw workspace/path/edit omission, shared contract parity |
