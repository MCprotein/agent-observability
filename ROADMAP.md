...
| v0.6.1 | Planned | Baseline correctness and contract freeze | golden source/durable/report fixtures, unknown metadata rejection, fail-closed privacy regression, private artifact permissions, explicit correlation fields without downstream agent-ID parsing, lifecycle/replay contract definition, token-cost correctness fix without new JavaScript feature scope, cross-agent report fixtures |
