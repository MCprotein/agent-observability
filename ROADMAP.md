...
| v0.10.0 | Planned | Rust Claude Code adapter | official-surface capability entry, telemetry/hook precedence, permission and compaction events, failed lifecycle, explicit interrupt gap and out-of-order fixture parity |
