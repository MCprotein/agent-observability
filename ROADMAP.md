...
| P2 | T/W/F 순수 계산·거부 사유 테스트와 독립 리뷰 통과; [파일 소유권 기준](docs/STORAGE_OWNERSHIP.md)에 따라 SQLite 쓰기 전 staging/예약 연결 구현·검증 중 | 수치 부분 코드 APPROVE / 아키텍처 CLEAR; staging 연결 리뷰·분류기·예약 동시성·실제 공간 산정과 실행 연결은 별도 검증 |
