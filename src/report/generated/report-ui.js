...
(() => {
  ...
  function validate29(data, { instancePath = "", parentData, parentDataProperty, rootData = data, dynamicAnchors = {} } = {}) {
    ...
    if (errors === 0) {
      if (data && typeof data == "object" && !Array.isArray(data)) {
        let missing6;
        if (data.schemaVersion === void 0 && (missing6 = "schemaVersion") || data.traceId === void 0 && (missing6 = "traceId") || data.spanId === void 0 && (missing6 = "spanId") || data.parentSpanId === void 0 && (missing6 = "parentSpanId") || data.kind === void 0 && (missing6 = "kind") || data.name === void 0 && (missing6 = "name") || data.status === void 0 && (missing6 = "status") || data.startTimeUnixMs === void 0 && (missing6 = "startTimeUnixMs") || data.endTimeUnixMs === void 0 && (missing6 = "endTimeUnixMs") || data.repo === void 0 && (missing6 = "repo") || data.agent === void 0 && (missing6 = "agent") || data.availability === void 0 && (missing6 = "availability") || data.attributes === void 0 && (missing6 = "attributes") || data.metrics === void 0 && (missing6 = "metrics") || data.cost === void 0 && (missing6 = "cost")) {
          validate29.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing6 }, message: "must have required property '" + missing6 + "'" }];
          return false;
        } else {
          const _errs33 = errors;
          for (const key0 in data) {
  ...
  function mount(data) {
    ...
    function renderTraces(page, spansByTrace) {
      ...
      tracesElement.replaceChildren(...page.items.map((trace) => {
        ...
        button.innerHTML = `<div class="trace-main"><span class="mono">${escapeHtml(shortId(trace.traceId))}</span><span class="badge ${traceSummary.errors ? "error" : "ok"}">${traceSummary.errors ? `${traceSummary.errors} error` : "ok"}</span></div><div class="trace-meta"><span>${escapeHtml(trace.repo)}</span><span>${traceSpans.length} spans</span><span>${formatNumber(traceSummary.totalTokens)} tokens</span></div>`;
        return button;
      }));
    }
