...
(() => {
  ...
  function validate29(data, { instancePath = "", parentData, parentDataProperty, rootData = data, dynamicAnchors = {} } = {}) {
    ...
    if (data && typeof data == "object" && !Array.isArray(data)) {
      if (data.metrics !== void 0) {
        ...
        if (errors === _errs7) {
          if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
            let missing0;
            if (data0.totalTokens === void 0 && (missing0 = "totalTokens")) {
              const err1 = {};
              if (vErrors === null) {
                vErrors = [err1];
              } else {
        ...
        if (errors === _errs9) {
          if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
            let missing1;
            if (data0.totalAccumulatedTokens === void 0 && (missing1 = "totalAccumulatedTokens")) {
              const err3 = {};
              if (vErrors === null) {
                vErrors = [err3];
              } else {
        ...
        if (errors === _errs11) {
          if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
            let missing2;
            if (data0.inputTokens === void 0 && (missing2 = "inputTokens") || data0.outputTokens === void 0 && (missing2 = "outputTokens")) {
              const err5 = {};
              if (vErrors === null) {
                vErrors = [err5];
              } else {
        ...
        if (errors === _errs13) {
          if (data0 && typeof data0 == "object" && !Array.isArray(data0)) {
            let missing3;
            if (data0.totalInputTokens === void 0 && (missing3 = "totalInputTokens") || data0.totalOutputTokens === void 0 && (missing3 = "totalOutputTokens")) {
              const err7 = {};
              if (vErrors === null) {
                vErrors = [err7];
              } else {
    ...
    if (errors === 0) {
      if (data && typeof data == "object" && !Array.isArray(data)) {
        let missing4;
        if (data.schemaVersion === void 0 && (missing4 = "schemaVersion") || data.traceId === void 0 && (missing4 = "traceId") || data.spanId === void 0 && (missing4 = "spanId") || data.parentSpanId === void 0 && (missing4 = "parentSpanId") || data.kind === void 0 && (missing4 = "kind") || data.name === void 0 && (missing4 = "name") || data.status === void 0 && (missing4 = "status") || data.startTimeUnixMs === void 0 && (missing4 = "startTimeUnixMs") || data.endTimeUnixMs === void 0 && (missing4 = "endTimeUnixMs") || data.repo === void 0 && (missing4 = "repo") || data.agent === void 0 && (missing4 = "agent") || data.availability === void 0 && (missing4 = "availability") || data.attributes === void 0 && (missing4 = "attributes") || data.metrics === void 0 && (missing4 = "metrics") || data.cost === void 0 && (missing4 = "cost")) {
          validate29.errors = [{ instancePath, schemaPath: "#/required", keyword: "required", params: { missingProperty: missing4 }, message: "must have required property '" + missing4 + "'" }];
          return false;
        } else {
          const _errs29 = errors;
          for (const key0 in data) {
